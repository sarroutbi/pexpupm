...
FALTA DIAGRAMA DE ESTADOS START GAME.
...
FALTA DIAGRAMA DE ESTADOS DE RESET GAME.

Las acciones en las que se reparten las cartas y se termina la partida no merecen mención especial, ya que son casos muy claros una vez conocido el funcionamiento del juego. Sin embargo, el modelo de casos de uso debe hacer hincapié en qué pasa cuando se posiciona una carta desde un mazo a otro dentro del juego.
...
\begin{center}
 ...
 \begin{center}
   ...
   \caption{Diagrama de Interacción: ``Reset Game'' y ``Start Game''}
   \label{fig:exitgamesequence}
 \end{center}
 \end{figure}
\end{center}
